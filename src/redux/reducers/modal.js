					...
					<ul className="nav l-nav" role="tablist">
						...
						<div className="tab-pane fade" id="pills-m_register" role="tabpanel" aria-labelledby="pills-m_register-tab">
							...
							<div className="form-area">
								<form action="#" method="POST">
									<div className="form-group">
											<input type="text" className="input-field" id="input-name1"  placeholder="Username"/>
									</div>
									<div className="form-group">
											<input type="email" className="input-field" id="input-email1"  placeholder="Enter your Email"/>
									</div>
									<div className="form-group">
