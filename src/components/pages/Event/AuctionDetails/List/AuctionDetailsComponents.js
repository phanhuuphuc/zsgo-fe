				...
				<div className="row">
					<div className="col-lg-12">
						<div className="turnaments-info">
							...
							<br />
							<br />
							<h4>HOW TO JOIN TOURNAMENT:</h4>
							<ul>
								<li>1) Click Join Now</li>
								<li>2) Create a Team</li>
								<li>3) Invite Members</li>
								<li>4) Members Accept Invite</li>
								<li>5) Refresh &amp; Enroll Now!</li>
							</ul>
							<br />
							<br />
							<h4>HOW TO START A MATCH:</h4>
							<ul>
								<li>1) Wait for bracket to generate</li>
								<li>2) You will receive a pop up/notification once your match has scheduled</li>
								<li>3) Click link directing you to the match details page</li>
								<li>4) Invite member on EPIC games account to start the match</li>
							</ul>
							<br />
							<br />
							<h4>PRIZE CLAIM</h4>
							<p>
								Prize claims must be completed within 24 hours of the end of the tournament otherwise
								risk penalty of the prize. Claims can take up to 72 hours to be processed. Players who
								reside in any of the below states are not eligible to receive and/or claim any prizes
								from Jugaro Gaming;
							</p>
						</div>
					</div>
...
export default AuctionDetailsComponents;
