  ...
  return (
    <React.Fragment>
                          ...
                          <li>
                            <div className="info-box">
                              ...
                              <div className="content">
                                ...
                                <p>
                                  Join a grand adventure of 7 levels and
                      ...
                      <div className="l-arcive-box2-wrapper">
                        <div className="l-arcive-box2">
                          <div className="s-a-b">
                            <div className="left">
                              <img
                                src="./assets/images/arcive/sa4.png"
                                alt=""
                              />
                              <div className="content">
                                <div className="left2">
                                  <img
                                    src="./assets/images/arcive/m1.png"
                                    alt=""
                                  />
                                </div>
                          ...
                          <div className="s-a-b">
                            <div className="left">
                              <img
                                src="./assets/images/arcive/sa5.png"
                                alt=""
                              />
                              <div className="content">
                                <div className="left2">
                                  <img
                                    src="./assets/images/arcive/m2.png"
                                    alt=""
                                  />
                                </div>
                                <div className="right2">
                          ...
                          <div className="s-a-b">
                            <div className="left">
                              <img
                                src="./assets/images/arcive/sa6.png"
                                alt=""
                              />
                              <div className="content">
                                <div className="left2">
                                  <img
                                    src="./assets/images/arcive/m3.png"
                                    alt=""
                                  />
                                </div>
                                <div className="right2">
                            ...
                            <div className="right">
                              <img
                                src="./assets/images/arcive/mony.png"
                                alt=""
                              />
                              <h6>25.8772200 BTC</h6>
                            </div>
                          ...
                          <div className="s-a-b">
                            <div className="left">
                              <img
                                src="./assets/images/arcive/sa7.png"
                                alt=""
                              />
                              <div className="content">
                                <div className="left2">
                                  <img
                                    src="./assets/images/arcive/m4.png"
                                    alt=""
                                  />
                                </div>
                                <div className="right2">
                          ...
                          <div className="s-a-b">
                            <div className="left">
                              <img
                                src="./assets/images/arcive/sa8.png"
                                alt=""
                              />
                              <div className="content">
                                <div className="left2">
                                  <img
                                    src="./assets/images/arcive/m5.png"
                                    alt=""
                                  />
                                </div>
                                <div className="right2">
                          ...
                          <div className="s-a-b">
                            <div className="left">
                              <img
                                src="./assets/images/arcive/sa9.png"
                                alt=""
                              />
                              <div className="content">
                                <div className="left2">
                                  <img
                                    src="./assets/images/arcive/m6.png"
                                    alt=""
                                  />
                                </div>
                                <div className="right2">
                      ...
                      <div className="l-arcive-box2-wrapper">
                        <div className="l-arcive-box2">
                          ...
                          <div className="s-a-b">
                            ...
                            <div className="right">
                              <img
                                src="./ssets/images/arcive/mony.pnga"
                                alt=""
                              />
                              <h6>25.8772200 BTC</h6>
                            </div>
      ...
      <section className="join_us join_us2 join_us3">
        <img
          className="l-image"
          src="./assets/images/joinus_left_img.png"
          alt=""
        />
            ...
            <div className="col-xl-7">
              <div className="section-heading content-left">
                ...
                <h6 className="text">
                  ...
                  early access to Jugaro and experience crypto like never
                  before.
                </h6>
                <a href="#" className="mybtn1">
                  Join US
                ...
                <div className="content">
                  ...
                  <div className="middle-area">
                    ...
                    <p>
                      ...
                      Vivamus dictum dictum congue. Duis fringilla malesuada
                      lobortis. In ultricies venenatis magna ut mollis. Nam sit
                      amet arcu lobortis, porta nisl non, egestas felis. Nulla
                      et finibus massa. Ut varius tristique elit et gravida.
                    </p>
                  </div>
              ...
              <div id="mycontainer">
                <aside>
                  ...
                  <ul>
                    <li>
                      <img
                        src="./assets/images/profiles/chat_avatar_01.jpg"
                        alt=""
                      />
                      <div>
                        <h2>Prénom Nom</h2>
                    ...
                    <li>
                      <img
                        src="./assets/images/profiles/chat_avatar_02.jpg"
                        alt=""
                      />
                      <div>
                        <h2>Prénom Nom</h2>
                    ...
                    <li>
                      <img
                        src="./assets/images/profiles/chat_avatar_03.jpg"
                        alt=""
                      />
                      <div>
                        <h2>Prénom Nom</h2>
                    ...
                    <li>
                      <img
                        src="./assets/images/profiles/chat_avatar_04.jpg"
                        alt=""
                      />
                      <div>
                        <h2>Prénom Nom</h2>
                    ...
                    <li>
                      <img
                        src="./assets/images/profiles/chat_avatar_05.jpg"
                        alt=""
                      />
                      <div>
                        <h2>Prénom Nom</h2>
                    ...
                    <li>
                      <img
                        src="./assets/images/profiles/chat_avatar_06.jpg"
                        alt=""
                      />
                      <div>
                        <h2>Prénom Nom</h2>
                    ...
                    <li>
                      <img
                        src="./assets/images/profiles/chat_avatar_07.jpg"
                        alt=""
                      />
                      <div>
                        <h2>Prénom Nom</h2>
                    ...
                    <li>
                      <img
                        src="./assets/images/profiles/chat_avatar_08.jpg"
                        alt=""
                      />
                      <div>
                        <h2>Prénom Nom</h2>
                    ...
                    <li>
                      <img
                        src="./assets/images/profiles/chat_avatar_09.jpg"
                        alt=""
                      />
                      <div>
                        <h2>Prénom Nom</h2>
                    ...
                    <li>
                      <img
                        src="./assets/images/profiles/chat_avatar_10.jpg"
                        alt=""
                      />
                      <div>
                        <h2>Prénom Nom</h2>
