import GamerProfile from "../List/GamerProfileComponents";
const Overview = () => {
  return (
    // <GamerProfile>
              ...
              <div className="col-xl-3 col-lg-4">
                <aside>
                  <div className="about">
                    <h4>About Me</h4>
                    <p>
                      Nothing Interesting hasn't been written here, what a pity it
                      is quite a nice field
                    </p>
                    <ul>
                      <li>
                        <p>
                      ...
                      <li>
                        <p>
                          {" "}
                          <i className="fas fa-calendar-alt"></i> Member Since 08
                          Jan 2021
                        </p>
                      </li>
                    </ul>
