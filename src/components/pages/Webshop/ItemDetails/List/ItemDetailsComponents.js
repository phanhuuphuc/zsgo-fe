							...
							<div className="details-wrapper">
								<div className="left-content">
									...
									<div className="lr-content">
										...
										<h4>ABOUT GAME</h4>
										<p>
											Booyah! is multiplayer game, where you have to battle against your opponents
											with various weapons. You play this as first person shooter and you can join
											multiple game modes: Be king of the hill in a free-for-all, or cooperate
											with teammates to win in a team deathmatch.
										</p>
									</div>
								</div>
								<div className="right-content">
									<div className="price-box">
										...
										<div className="players">2</div>
										<div className="price-pool-area">
											<div className="left">Prize pool:</div>
											<div className="right">
